...
add({
  ...
  'ตัดค่าพักชูการ์ออกจากบิล — กรณีฝากเฉพาะบุชเบบี้/ดอร์เมาส์ค่ะ':'Removes the sugar glider stay charge — for bushbaby/dormouse-only boarding',
  'ไม่มีชูการ์มาฝาก':'No sugar glider boarding',
  'ไม่คิดค่าพักชูการ์':'sugar glider stay not charged',
  'รวมบิลหลายกรง':'Merge bills (multiple cages)',
  'ถ้าน้องครอบครัวเดียวกันพักแยกหลายกรง ติ๊กเลือกกรงเพิ่มด้านล่าง เพื่อออกใบเสร็จรวมใบเดียวได้เลยค่ะ':'If one family stayed in several cages, tick the extra cages below to issue one combined receipt',
